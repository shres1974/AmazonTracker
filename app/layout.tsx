...
export const metadata: Metadata = {
  title: 'TrackMyAmazon',
  description:
    'An Amazon Price Tracker monitors prices and alerts users to drops for smarter shopping.',
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${inter.className} bg-gradient-to-r from-teal-50 to-indigo-50 text-gray-900 min-h-screen flex flex-col`}
      >
        <Navbar />
